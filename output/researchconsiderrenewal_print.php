...
require_once("include/researchconsiderrenewal_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchConsiderRenewal" );
