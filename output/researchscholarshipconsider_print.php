...
require_once("include/researchscholarshipconsider_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchScholarshipConsider" );
