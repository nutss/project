...
require_once("include/researchscholarshipproposal_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchScholarshipProposal" );
