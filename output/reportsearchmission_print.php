...
require_once("include/reportsearchmission_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ReportSearchMission" );
