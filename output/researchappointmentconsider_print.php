...
require_once("include/researchappointmentconsider_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchAppointmentConsider" );
