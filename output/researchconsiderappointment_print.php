...
require_once("include/researchconsiderappointment_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchConsiderAppointment" );
