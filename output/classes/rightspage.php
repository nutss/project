...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ".
			...
			." from ".
			$grConnection->addTableWrappers( "project_uggroups" ) .
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "project_ugrights" )
	...
	function updateTablePermissions( $table, $group, $tableRights )
	{
		...
		$rightWTableName = $this->connection->addTableWrappers( "project_ugrights" );
