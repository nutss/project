...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "amphures", "varname" => "mc_at_192_168_1_111__amphures", "altvarname" => "amphures", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			...
			$dalTables[$conn->connId][] = array("name" => "districts", "varname" => "mc_at_192_168_1_111__districts", "altvarname" => "districts", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			$dalTables[$conn->connId][] = array("name" => "geographies", "varname" => "mc_at_192_168_1_111__geographies", "altvarname" => "geographies", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			...
			$dalTables[$conn->connId][] = array("name" => "provinces", "varname" => "mc_at_192_168_1_111__provinces", "altvarname" => "provinces", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			$dalTables[$conn->connId][] = array("name" => "researchAppointment", "varname" => "mc_at_192_168_1_111__researchAppointment", "altvarname" => "researchAppointment", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			$dalTables[$conn->connId][] = array("name" => "researchAppointmentConsider", "varname" => "mc_at_192_168_1_111__researchAppointmentConsider", "altvarname" => "researchAppointmentConsider", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			...
			$dalTables[$conn->connId][] = array("name" => "researcher", "varname" => "mc_at_192_168_1_111__researcher", "altvarname" => "researcher", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			...
			$dalTables[$conn->connId][] = array("name" => "researchScholarshipProposal", "varname" => "mc_at_192_168_1_111__researchScholarshipProposal", "altvarname" => "researchScholarshipProposal", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
			...
			$dalTables[$conn->connId][] = array("name" => "researchTypeGroup", "varname" => "mc_at_192_168_1_111__researchTypeGroup", "altvarname" => "researchTypeGroup", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "project at 192.168.1.111");
