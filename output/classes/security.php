...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "project_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getTableDataSource( "project_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getTableDataSource( "project_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getTableDataSource( "project_ugrights", $cman->getUserGroupsConnId() );
	}
