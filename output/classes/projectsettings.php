...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("staffUsers", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "staffUsers" ] = array( "url" => "staffusers", "type" => 0 );
	...
	$projectEntitiesReverse[ "researchappointment" ] = "researchAppointment";
	$projectEntities[ "researchDisburse" ] = array( "url" => "researchdisburse", "type" => 1 );
	$projectEntitiesReverse[ "researchdisburse" ] = "researchDisburse";
	$projectEntities[ "researchRenewal" ] = array( "url" => "researchrenewal", "type" => 0 );
	$projectEntitiesReverse[ "researchrenewal" ] = "researchRenewal";
	...
	$projectEntities[ "researchConsider" ] = array( "url" => "researchconsider", "type" => 0 );
	$projectEntitiesReverse[ "researchconsider" ] = "researchConsider";
	$projectEntities[ "researchScholarshipRegister" ] = array( "url" => "researchscholarshipregister", "type" => 0 );
	$projectEntitiesReverse[ "researchscholarshipregister" ] = "researchScholarshipRegister";
	$projectEntities[ "researchScholarshipProposal" ] = array( "url" => "researchscholarshipproposal", "type" => 0 );
	$projectEntitiesReverse[ "researchscholarshipproposal" ] = "researchScholarshipProposal";
	$projectEntities[ "researchScholarshipConsider" ] = array( "url" => "researchscholarshipconsider", "type" => 0 );
	$projectEntitiesReverse[ "researchscholarshipconsider" ] = "researchScholarshipConsider";
	$projectEntities[ "researchProjectProposal" ] = array( "url" => "researchprojectproposal", "type" => 1 );
	$projectEntitiesReverse[ "researchprojectproposal" ] = "researchProjectProposal";
	$projectEntities[ "researchDisburseConsider" ] = array( "url" => "researchdisburseconsider", "type" => 0 );
	$projectEntitiesReverse[ "researchdisburseconsider" ] = "researchDisburseConsider";
	$projectEntities[ "researchAppointmentConsider" ] = array( "url" => "researchappointmentconsider", "type" => 0 );
	$projectEntitiesReverse[ "researchappointmentconsider" ] = "researchAppointmentConsider";
	$projectEntities[ "researchRenewalConsider" ] = array( "url" => "researchrenewalconsider", "type" => 0 );
	$projectEntitiesReverse[ "researchrenewalconsider" ] = "researchRenewalConsider";
	$projectEntities[ "researchPeriod" ] = array( "url" => "researchperiod", "type" => 1 );
	...
	$projectEntities[ "ReportMonitorGraphTrackingStatus1" ] = array( "url" => "reportmonitorgraphtrackingstatus1", "type" => 3 );
	$projectEntitiesReverse[ "reportmonitorgraphtrackingstatus1" ] = "ReportMonitorGraphTrackingStatus1";
	...
	$projectEntities[ "ReportMonitorGraphTrackingStatus2" ] = array( "url" => "reportmonitorgraphtrackingstatus2", "type" => 3 );
	$projectEntitiesReverse[ "reportmonitorgraphtrackingstatus2" ] = "ReportMonitorGraphTrackingStatus2";
	$projectEntities[ "ReportMonitorGraphTrackingStatus3" ] = array( "url" => "reportmonitorgraphtrackingstatus3", "type" => 3 );
	$projectEntitiesReverse[ "reportmonitorgraphtrackingstatus3" ] = "ReportMonitorGraphTrackingStatus3";
	$projectEntities[ "ReportMonitorProjectStatus5" ] = array( "url" => "reportmonitorprojectstatus5", "type" => 1 );
	$projectEntitiesReverse[ "reportmonitorprojectstatus5" ] = "ReportMonitorProjectStatus5";
	$projectEntities[ "ReportMonitorProjectStatus6" ] = array( "url" => "reportmonitorprojectstatus6", "type" => 1 );
	$projectEntitiesReverse[ "reportmonitorprojectstatus6" ] = "ReportMonitorProjectStatus6";
	$projectEntities[ "ReportMonitorProjectStatus7" ] = array( "url" => "reportmonitorprojectstatus7", "type" => 1 );
	$projectEntitiesReverse[ "reportmonitorprojectstatus7" ] = "ReportMonitorProjectStatus7";
	$projectEntities[ "ReportMonitorProjectStatus8" ] = array( "url" => "reportmonitorprojectstatus8", "type" => 1 );
	$projectEntitiesReverse[ "reportmonitorprojectstatus8" ] = "ReportMonitorProjectStatus8";
	$projectEntities[ "ReportMonitor" ] = array( "url" => "reportmonitor", "type" => 4 );
	$projectEntitiesReverse[ "reportmonitor" ] = "ReportMonitor";
	$projectEntities[ "ReportSearchresearchRegister" ] = array( "url" => "reportsearchresearchregister", "type" => 1 );
	$projectEntitiesReverse[ "reportsearchresearchregister" ] = "ReportSearchresearchRegister";
	$projectEntities[ "ReportMission" ] = array( "url" => "reportmission", "type" => 1 );
	$projectEntitiesReverse[ "reportmission" ] = "ReportMission";
	$projectEntities[ "ReportGraphmissionFollow" ] = array( "url" => "reportgraphmissionfollow", "type" => 3 );
	$projectEntitiesReverse[ "reportgraphmissionfollow" ] = "ReportGraphmissionFollow";
	$projectEntities[ "DashboardMission" ] = array( "url" => "dashboardmission", "type" => 4 );
	$projectEntitiesReverse[ "dashboardmission" ] = "DashboardMission";
	$projectEntities[ "researcher" ] = array( "url" => "researcher", "type" => 0 );
	$projectEntitiesReverse[ "researcher" ] = "researcher";
	$projectEntities[ "researchResearcher" ] = array( "url" => "researchresearcher", "type" => 1 );
	$projectEntitiesReverse[ "researchresearcher" ] = "researchResearcher";
	$projectEntities[ "optionSub_Search_Lookup" ] = array( "url" => "optionsub_search_lookup", "type" => 1 );
	$projectEntitiesReverse[ "optionsub_search_lookup" ] = "optionSub_Search_Lookup";
	$projectEntities[ "researchTypeGroup" ] = array( "url" => "researchtypegroup", "type" => 0 );
	$projectEntitiesReverse[ "researchtypegroup" ] = "researchTypeGroup";
	$projectEntities[ "TypeGroup_Search_Lookup" ] = array( "url" => "typegroup_search_lookup", "type" => 1 );
	$projectEntitiesReverse[ "typegroup_search_lookup" ] = "TypeGroup_Search_Lookup";
	$projectEntities[ "geographies" ] = array( "url" => "geographies", "type" => 0 );
	$projectEntitiesReverse[ "geographies" ] = "geographies";
	$projectEntities[ "provinces" ] = array( "url" => "provinces", "type" => 0 );
	$projectEntitiesReverse[ "provinces" ] = "provinces";
	$projectEntities[ "districts" ] = array( "url" => "districts", "type" => 0 );
	$projectEntitiesReverse[ "districts" ] = "districts";
	$projectEntities[ "amphures" ] = array( "url" => "amphures", "type" => 0 );
	$projectEntitiesReverse[ "amphures" ] = "amphures";
}
