...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("researchOperatingPeriod" == $this->chrt_array['tables'][0])
			return true;
		if("researchAppointment" == $this->chrt_array['tables'][0])
			return true;
		if("researchOperatingPeriod" == $this->chrt_array['tables'][0])
			return true;
		if("researchRenewal" == $this->chrt_array['tables'][0])
			return true;
		...
		if("researchScholarshipProposal" == $this->chrt_array['tables'][0])
			return true;
		if("researchScholarshipConsider" == $this->chrt_array['tables'][0])
			return true;
		if("researchScholarshipProposal" == $this->chrt_array['tables'][0])
			return true;
		if("researchDisburseConsider" == $this->chrt_array['tables'][0])
			return true;
		if("researchAppointmentConsider" == $this->chrt_array['tables'][0])
			return true;
		if("researchRenewalConsider" == $this->chrt_array['tables'][0])
			return true;
		if("researchOperatingPeriod" == $this->chrt_array['tables'][0])
			return true;
		if("researchScholarshipRegister" == $this->chrt_array['tables'][0])
