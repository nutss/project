...
function checkTableName($shortTName )
{
	...
	if ("researchoperatingperiod" == $shortTName )
		return true;
	if ("researchappointment" == $shortTName )
		return true;
	if ("researchdisburse" == $shortTName )
		return true;
	if ("researchrenewal" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("researchconsider" == $shortTName )
		return true;
	if ("researchscholarshipregister" == $shortTName )
		return true;
	if ("researchscholarshipproposal" == $shortTName )
		return true;
	if ("researchscholarshipconsider" == $shortTName )
		return true;
	if ("researchprojectproposal" == $shortTName )
		return true;
	if ("researchdisburseconsider" == $shortTName )
		return true;
	if ("researchappointmentconsider" == $shortTName )
		return true;
	if ("researchrenewalconsider" == $shortTName )
		return true;
	...
	if ("reportprogress" == $shortTName )
		return true;
	if ("reportmonitorgraphtrackingstatus1" == $shortTName )
		return true;
	...
	if ("reportmonitorprojectstatus4" == $shortTName )
		return true;
	if ("reportmonitorgraphtrackingstatus2" == $shortTName )
		return true;
	if ("reportmonitorgraphtrackingstatus3" == $shortTName )
		return true;
	if ("reportmonitorprojectstatus5" == $shortTName )
		return true;
	if ("reportmonitorprojectstatus6" == $shortTName )
		return true;
	if ("reportmonitorprojectstatus7" == $shortTName )
		return true;
	if ("reportmonitorprojectstatus8" == $shortTName )
		return true;
	if ("reportmonitor" == $shortTName )
		return true;
	if ("reportsearchresearchregister" == $shortTName )
		return true;
	if ("reportmission" == $shortTName )
		return true;
	if ("reportgraphmissionfollow" == $shortTName )
		return true;
	if ("dashboardmission" == $shortTName )
		return true;
	if ("researcher" == $shortTName )
		return true;
	if ("researchresearcher" == $shortTName )
		return true;
	if ("optionsub_search_lookup" == $shortTName )
		return true;
	if ("researchtypegroup" == $shortTName )
		return true;
	if ("typegroup_search_lookup" == $shortTName )
		return true;
	if ("geographies" == $shortTName )
		return true;
	if ("provinces" == $shortTName )
		return true;
	if ("districts" == $shortTName )
		return true;
	if ("amphures" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("staffUsers");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("process");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchOperatingPeriod");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchAppointment");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchDisburse");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchRenewal");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchConsider");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchConsider";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchScholarshipRegister");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchScholarshipRegister";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchScholarshipProposal");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchScholarshipProposal";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchScholarshipConsider");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchScholarshipConsider";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchProjectProposal");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchProjectProposal";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchDisburseConsider");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchDisburseConsider";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchAppointmentConsider");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchAppointmentConsider";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchRenewalConsider");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchPeriod");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchProjectRegister");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorGraphTrackingStatus1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorGraphTrackingStatus1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorGraphTrackingStatus2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorGraphTrackingStatus2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorGraphTrackingStatus3");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorGraphTrackingStatus3";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorProjectStatus5");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorProjectStatus5";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorProjectStatus6");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorProjectStatus6";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorProjectStatus7");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorProjectStatus7";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMonitorProjectStatus8");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportMonitorProjectStatus8";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportSearchresearchRegister");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportSearchresearchRegister";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportMission");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ReportGraphmissionFollow");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ReportGraphmissionFollow";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DashboardMission");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="DashboardMission";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researcher");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchResearcher");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchResearcher";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("optionSub_Search_Lookup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="optionSub_Search_Lookup";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("researchTypeGroup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="researchTypeGroup";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TypeGroup_Search_Lookup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TypeGroup_Search_Lookup";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("geographies");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("provinces");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("districts");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("amphures");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
{
	if($shorttable=="reportmonitorgraphtrackingstatus1")
		return "2DPie";
	if($shorttable=="reportmonitorgraphtrackingstatus2")
		return "2DPie";
	if($shorttable=="reportmonitorgraphtrackingstatus3")
		return "2DPie";
	if($shorttable=="reportgraphmissionfollow")
		return "2DColumn";
	return "";
}
...
//	default permissions
	...
	if( $table=="researchOperatingPeriod" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchAppointment" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchDisburse" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchRenewal" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="researchConsider" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchScholarshipRegister" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchScholarshipProposal" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchScholarshipConsider" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchProjectProposal" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchDisburseConsider" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchAppointmentConsider" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchRenewalConsider" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="researchPeriod" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
function SetLangVars($xt, $prefix, $pageName = "", $extraparams = "")
{
	...
	$xt->assign("ThaiLANGLINK", "Thai" != $currentLang);
