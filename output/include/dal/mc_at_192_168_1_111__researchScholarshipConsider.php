<?php
$dalTableresearchScholarshipConsider = array();
$dalTableresearchScholarshipConsider["id"] = array("type"=>3,"varname"=>"id", "name" => "id");
$dalTableresearchScholarshipConsider["researchProjectID"] = array("type"=>3,"varname"=>"researchProjectID", "name" => "researchProjectID");
$dalTableresearchScholarshipConsider["researchConsiderNumber"] = array("type"=>200,"varname"=>"researchConsiderNumber", "name" => "researchConsiderNumber");
...
$dal_info["mc_at_192_168_1_111__researchScholarshipConsider"] = &$dalTableresearchScholarshipConsider;
?>