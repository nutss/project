<?php
$dalTableresearchConsider = array();
$dalTableresearchConsider["id"] = array("type"=>3,"varname"=>"id", "name" => "id");
$dalTableresearchConsider["researchTypeID"] = array("type"=>3,"varname"=>"researchTypeID", "name" => "researchTypeID");
$dalTableresearchConsider["researchConsiderNumber"] = array("type"=>200,"varname"=>"researchConsiderNumber", "name" => "researchConsiderNumber");
$dalTableresearchConsider["processName"] = array("type"=>200,"varname"=>"processName", "name" => "processName");
$dalTableresearchConsider["stepName"] = array("type"=>200,"varname"=>"stepName", "name" => "stepName");
...
$dal_info["mc_at_192_168_1_111__researchConsider"] = &$dalTableresearchConsider;
?>