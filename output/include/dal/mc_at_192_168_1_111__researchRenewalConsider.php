<?php
$dalTableresearchRenewalConsider = array();
$dalTableresearchRenewalConsider["id"] = array("type"=>3,"varname"=>"id", "name" => "id");
$dalTableresearchRenewalConsider["researchRenewalID"] = array("type"=>3,"varname"=>"researchRenewalID", "name" => "researchRenewalID");
$dalTableresearchRenewalConsider["researchConsiderNumber"] = array("type"=>200,"varname"=>"researchConsiderNumber", "name" => "researchConsiderNumber");
...
$dal_info["mc_at_192_168_1_111__researchRenewalConsider"] = &$dalTableresearchRenewalConsider;
?>