<?php
$dalTableresearchDisburseConsider = array();
$dalTableresearchDisburseConsider["id"] = array("type"=>3,"varname"=>"id", "name" => "id");
$dalTableresearchDisburseConsider["researchDisburseID"] = array("type"=>3,"varname"=>"researchDisburseID", "name" => "researchDisburseID");
$dalTableresearchDisburseConsider["researchConsiderNumber"] = array("type"=>200,"varname"=>"researchConsiderNumber", "name" => "researchConsiderNumber");
...
$dalTableresearchDisburseConsider["researchConsiderGroupAuthorized"] = array("type"=>200,"varname"=>"researchConsiderGroupAuthorized", "name" => "researchConsiderGroupAuthorized");
...
$dal_info["mc_at_192_168_1_111__researchDisburseConsider"] = &$dalTableresearchDisburseConsider;
?>