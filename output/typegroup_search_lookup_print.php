...
require_once("include/typegroup_search_lookup_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "TypeGroup_Search_Lookup" );
