...
require_once("include/researchprojectgroup_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchProjectGroup" );
