...
$pageMask[$table] = $mask;
$tables[$table] = array("consider", " " . GetTableCaption("consider"));
$table = "researchType";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("researchprojectgroup", " " . GetTableCaption("researchProjectGroup"));
