...
$nonAdminTablesArr[] = "researchRenewal";
$nonAdminTablesArr[] = "researchConsider";
$nonAdminTablesArr[] = "researchScholarshipRegister";
$nonAdminTablesArr[] = "researchScholarshipProposal";
$nonAdminTablesArr[] = "researchScholarshipConsider";
$nonAdminTablesArr[] = "researchProjectProposal";
$nonAdminTablesArr[] = "researchDisburseConsider";
$nonAdminTablesArr[] = "researchAppointmentConsider";
...
$nonAdminTablesArr[] = "ReportMonitorGraphTrackingStatus1";
...
$nonAdminTablesArr[] = "ReportMonitorGraphTrackingStatus2";
$nonAdminTablesArr[] = "ReportMonitorGraphTrackingStatus3";
$nonAdminTablesArr[] = "ReportMonitorProjectStatus5";
$nonAdminTablesArr[] = "ReportMonitorProjectStatus6";
$nonAdminTablesArr[] = "ReportMonitorProjectStatus7";
$nonAdminTablesArr[] = "ReportMonitorProjectStatus8";
$nonAdminTablesArr[] = "ReportMonitor";
$nonAdminTablesArr[] = "ReportSearchresearchRegister";
$nonAdminTablesArr[] = "ReportMission";
$nonAdminTablesArr[] = "ReportGraphmissionFollow";
$nonAdminTablesArr[] = "DashboardMission";
$nonAdminTablesArr[] = "researcher";
$nonAdminTablesArr[] = "researchResearcher";
$nonAdminTablesArr[] = "optionSub_Search_Lookup";
$nonAdminTablesArr[] = "researchTypeGroup";
$nonAdminTablesArr[] = "TypeGroup_Search_Lookup";
$nonAdminTablesArr[] = "geographies";
$nonAdminTablesArr[] = "provinces";
$nonAdminTablesArr[] = "districts";
$nonAdminTablesArr[] = "amphures";
...
$wGroupTableName = $ug_connection->addTableWrappers( "project_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "project_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "project_ugrights" );
