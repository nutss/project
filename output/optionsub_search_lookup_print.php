...
require_once("include/optionsub_search_lookup_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "optionSub_Search_Lookup" );
