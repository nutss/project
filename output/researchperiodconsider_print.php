...
require_once("include/researchperiodconsider_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchPeriodConsider" );
