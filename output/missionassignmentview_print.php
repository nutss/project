...
require_once("include/missionassignmentview_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "missionAssignmentView" );
