...
require_once("include/researchconsiderview_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchConsiderView" );
