...
require_once("include/researchconsiderdisburse_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchConsiderDisburse" );
