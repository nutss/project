...
function buttonHandler______($params)
{
	global $strTableName;
	$result = array();
...
$result["txt"] = "OperatingPeriodID=".$record["id"];
...
function buttonHandler______1($params)
{
	global $strTableName;
	$result = array();
