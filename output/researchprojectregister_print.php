...
require_once("include/researchprojectregister_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchProjectRegister" );
