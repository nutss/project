...
require_once("include/researchprojectmangement_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "researchProjectMangement" );
