...
require_once("include/taskdisburselistwaitapprve_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "taskDisburseListWaitApprve" );
