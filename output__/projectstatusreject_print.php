...
require_once("include/projectstatusreject_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "projectStatusReject" );
