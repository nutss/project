...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("ProjectContact" == $this->chrt_array['tables'][0])
			return true;
		if("ProjectStep" == $this->chrt_array['tables'][0])
			return true;
		if("ProjectType" == $this->chrt_array['tables'][0])
			return true;
		if("project" == $this->chrt_array['tables'][0])
			return true;
		if("taskTrack" == $this->chrt_array['tables'][0])
			return true;
		if("staffUsers" == $this->chrt_array['tables'][0])
			return true;
		if("project_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("staffUsers" == $this->chrt_array['tables'][0])
			return true;
		if("staffUsers" == $this->chrt_array['tables'][0])
		...
		if("project" == $this->chrt_array['tables'][0])
			return true;
		if("taskDisburse" == $this->chrt_array['tables'][0])
			return true;
		if("taskTrack" == $this->chrt_array['tables'][0])
			return true;
		if("project" == $this->chrt_array['tables'][0])
		...
		if("project" == $this->chrt_array['tables'][0])
			return true;
		if("taskRenew" == $this->chrt_array['tables'][0])
			return true;
		if("taskRenew" == $this->chrt_array['tables'][0])
			return true;
		if("ProjectStep" == $this->chrt_array['tables'][0])
			return true;
		if("ProjectCompany" == $this->chrt_array['tables'][0])
			return true;
		if("ProjectContact" == $this->chrt_array['tables'][0])
			return true;
		if("project" == $this->chrt_array['tables'][0])
