...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "ProjectContact" ] = array( "url" => "projectcontact", "type" => 0 );
	$projectEntitiesReverse[ "projectcontact" ] = "ProjectContact";
	$projectEntities[ "ProjectStep" ] = array( "url" => "projectstep", "type" => 0 );
	$projectEntitiesReverse[ "projectstep" ] = "ProjectStep";
	$projectEntities[ "ProjectType" ] = array( "url" => "projecttype", "type" => 0 );
	$projectEntitiesReverse[ "projecttype" ] = "ProjectType";
	$projectEntities[ "project" ] = array( "url" => "project", "type" => 0 );
	$projectEntitiesReverse[ "project" ] = "project";
	$projectEntities[ "taskTrack" ] = array( "url" => "tasktrack", "type" => 0 );
	$projectEntitiesReverse[ "tasktrack" ] = "taskTrack";
	...
	$projectEntities[ "projectStatusApprove" ] = array( "url" => "projectstatusapprove", "type" => 1 );
	$projectEntitiesReverse[ "projectstatusapprove" ] = "projectStatusApprove";
	$projectEntities[ "taskDisburse" ] = array( "url" => "taskdisburse", "type" => 0 );
	$projectEntitiesReverse[ "taskdisburse" ] = "taskDisburse";
	$projectEntities[ "taskTrackApprove" ] = array( "url" => "tasktrackapprove", "type" => 1 );
	$projectEntitiesReverse[ "tasktrackapprove" ] = "taskTrackApprove";
	$projectEntities[ "SummaryProject" ] = array( "url" => "summaryproject", "type" => 2 );
	$projectEntitiesReverse[ "summaryproject" ] = "SummaryProject";
	$projectEntities[ "SummaryProjectDelay" ] = array( "url" => "summaryprojectdelay", "type" => 2 );
	$projectEntitiesReverse[ "summaryprojectdelay" ] = "SummaryProjectDelay";
	$projectEntities[ "SummaryTaskTrack" ] = array( "url" => "summarytasktrack", "type" => 2 );
	$projectEntitiesReverse[ "summarytasktrack" ] = "SummaryTaskTrack";
	$projectEntities[ "projectAssign" ] = array( "url" => "projectassign", "type" => 1 );
	$projectEntitiesReverse[ "projectassign" ] = "projectAssign";
	$projectEntities[ "taskRenew" ] = array( "url" => "taskrenew", "type" => 0 );
	$projectEntitiesReverse[ "taskrenew" ] = "taskRenew";
	$projectEntities[ "taskRenewApprove" ] = array( "url" => "taskrenewapprove", "type" => 1 );
	$projectEntitiesReverse[ "taskrenewapprove" ] = "taskRenewApprove";
	$projectEntities[ "CB_ProjectStep01" ] = array( "url" => "cb_projectstep01", "type" => 1 );
	$projectEntitiesReverse[ "cb_projectstep01" ] = "CB_ProjectStep01";
	$projectEntities[ "ProjectCompany" ] = array( "url" => "projectcompany", "type" => 0 );
	$projectEntitiesReverse[ "projectcompany" ] = "ProjectCompany";
	$projectEntities[ "CB_ProjectContact01" ] = array( "url" => "cb_projectcontact01", "type" => 1 );
	$projectEntitiesReverse[ "cb_projectcontact01" ] = "CB_ProjectContact01";
	$projectEntities[ "projectStatusScreen" ] = array( "url" => "projectstatusscreen", "type" => 1 );
	$projectEntitiesReverse[ "projectstatusscreen" ] = "projectStatusScreen";
	$projectEntities[ "taskDisburseApprove" ] = array( "url" => "taskdisburseapprove", "type" => 1 );
	$projectEntitiesReverse[ "taskdisburseapprove" ] = "taskDisburseApprove";
	$projectEntities[ "taskRenewOinion" ] = array( "url" => "taskrenewoinion", "type" => 1 );
	$projectEntitiesReverse[ "taskrenewoinion" ] = "taskRenewOinion";
}
