...
$custom_labels["English"] = array();
	$custom_labels["English"]['____________'] = "Project Status";
		$custom_labels["English"]['_______'] = "Project All";
		$custom_labels["English"]['PROJECT_TYPE3'] = "Project Type 3";
		$custom_labels["English"]['PROJECT_TYPE4'] = "Project Type 4";
		$custom_labels["English"]['PROJECT_TYPE5'] = "Project Type 5";
		$custom_labels["English"]['PROJECT_TYPE6'] = "Project Type 6";
		$custom_labels["English"]['PROJECT_STATUS_ALL'] = "Project Status All";
		$custom_labels["English"]['PROJECT_STATUS_APPROVE'] = "Project Status Approve";
		$custom_labels["English"]['PROJECT_STATUS_REJECT'] = "Project Status Reject";
		$custom_labels["English"]['_____________'] = "Project Type";
		$custom_labels["English"]['______'] = "Staff Users";
		$custom_labels["English"]['TASK_PROGRESS'] = "Task Progress";
		$custom_labels["English"]['TASK_DISBURSE'] = "Task Disburse";
		$custom_labels["English"]['_____________________'] = "Follow-up";
		$custom_labels["English"]['__________________'] = "Task Progress List";
		$custom_labels["English"]['_____________1'] = "Task Track";
		$custom_labels["English"]['TASK_TRACK_LIST'] = "Task Track List";
		$custom_labels["English"]['______________'] = "Task Disburse List All";
		$custom_labels["English"]['______________1'] = "Project Renewal";
		$custom_labels["English"]['__________'] = "Setup";
		$custom_labels["English"]['______1'] = "Report";
		$custom_labels["English"]['______________2'] = "Disbursement";
		$custom_labels["English"]['_________'] = "Capital";
		$custom_labels["English"]['___________________'] = "Task Disburse List Wait Apprve";
		$custom_labels["English"]['TASK_RENEW_STATUS_ALL'] = "Task Renew Status All";
		$custom_labels["English"]['___________'] = "Project All";
		$custom_labels["English"]['PROJECT_TYPE1'] = "Project Type 1";
		$custom_labels["English"]['___________1'] = "Project All";
		$custom_labels["English"]['PROJECT_TYPE2'] = "Project Type 2";
		$custom_labels["English"]['______________________________________'] = "Project All";
		$custom_labels["English"]['______________________________________1'] = "Project All";
		$custom_labels["English"]['____HIGHER_EDUCATION_SANDBOX'] = "Project All";
		$custom_labels["English"]['______________________________________2'] = "Project All";
		$custom_labels["English"]['______________3'] = "Project Status All";
		$custom_labels["English"]['______________4'] = "Project Status All";
		$custom_labels["English"]['_______________________________________'] = "Project Status Approve";
		$custom_labels["English"]['____________________'] = "Project Status Approve";
		$custom_labels["English"]['______________________'] = "Project Screen Status";
		$custom_labels["English"]['_____________________________'] = "Project Status Screen";
		$custom_labels["English"]['TASK_DISBURSE_APPROVE'] = "Task Disburse Approve";
		$custom_labels["English"]['____________________1'] = "Opinion Status";
		$custom_labels["English"]['____________________2'] = "Approve Status";
	$custom_labels["Thai"] = array();
		$custom_labels["Thai"]['____________'] = "ระบบยื่นคําขอรับทุนวิจัย (สถานะโครงการ)";
		$custom_labels["Thai"]['_______'] = "ทุนทั้งหมด";
		$custom_labels["Thai"]['PROJECT_TYPE3'] = "ทุน Reinventing";
		$custom_labels["Thai"]['PROJECT_TYPE4'] = "ทุน อาจารย์ รุ่นใหม่";
		$custom_labels["Thai"]['PROJECT_TYPE5'] = "ทุน Higher Education Sandbox";
		$custom_labels["Thai"]['PROJECT_TYPE6'] = "ทุน พัฒนาศักยภาพของ SME";
		$custom_labels["Thai"]['PROJECT_STATUS_ALL'] = "สถานะอนุมัติทุนวิจัยทั้งหมด";
		$custom_labels["Thai"]['PROJECT_STATUS_APPROVE'] = "สถานะอนุมัติทุนวิจัย";
		$custom_labels["Thai"]['PROJECT_STATUS_REJECT'] = "สถานะไม่อนุมัติทุนวิจัย";
		$custom_labels["Thai"]['_____________'] = "ประเภททุนวิจัย";
		$custom_labels["Thai"]['______'] = "ผู้ใช้งาน";
		$custom_labels["Thai"]['TASK_PROGRESS'] = "สถานะความคืบหน้า";
		$custom_labels["Thai"]['TASK_DISBURSE'] = "การเบิกจ่าย";
		$custom_labels["Thai"]['_____________________'] = "ระบบนัดหมายการติดตามงาน (สถานะงานตามงวด)";
		$custom_labels["Thai"]['__________________'] = "รายงานความคืบหน้า";
		$custom_labels["Thai"]['_____________1'] = "รายการติดตามโครงการ";
		$custom_labels["Thai"]['TASK_TRACK_LIST'] = "สถานะงานตามงวดทั้งหมด";
		$custom_labels["Thai"]['______________'] = "สถานะเบิกจ่ายทั้งหมด";
		$custom_labels["Thai"]['______________1'] = "ระบบยื่นคําขอขยายระยะเวลาโครงการที่ล่าช้า (สถานะคำขอขยายเวลา)";
		$custom_labels["Thai"]['__________'] = "การตั้งค่า";
		$custom_labels["Thai"]['______1'] = "รายงาน";
		$custom_labels["Thai"]['______________2'] = "ระบบการขออนุมัติการเบิกจ่าย (สถานะอนุมัติเบิกจ่าย)";
		$custom_labels["Thai"]['_________'] = "ระบบยื่นคําขอรับทุนวิจัย (ประเภททุน)";
		$custom_labels["Thai"]['___________________'] = "สถานะรออนุมัติการเบิกจ่าย";
		$custom_labels["Thai"]['TASK_RENEW_STATUS_ALL'] = "สถานะคำขอขยายเวลาทั้งหมด";
		$custom_labels["Thai"]['___________'] = "ทุน ​Talent Mobility";
		$custom_labels["Thai"]['PROJECT_TYPE1'] = "ทุน​ Talent Mobility";
		$custom_labels["Thai"]['___________1'] = "ทุน อุตสาหกรรมป้องกันประเทศ";
		$custom_labels["Thai"]['PROJECT_TYPE2'] = "ทุน อุตสาหกรรมป้องกันประเทศ";
		$custom_labels["Thai"]['______________________________________'] = "ทุน Reinventing";
		$custom_labels["Thai"]['______________________________________1'] = "ทุน อาจารย์ รุ่นใหม่";
		$custom_labels["Thai"]['____HIGHER_EDUCATION_SANDBOX'] = "ทุน Higher Education Sandbox";
		$custom_labels["Thai"]['______________________________________2'] = "ทุน พัฒนาศักยภาพของ SME";
		$custom_labels["Thai"]['______________3'] = "สถานะอนุมัติทุนวิจัย";
		$custom_labels["Thai"]['______________4'] = "สถานะไม่อนุมัติทุนวิจัย";
		$custom_labels["Thai"]['_______________________________________'] = "สถานะรออนุมัติทุนวิจัย";
		$custom_labels["Thai"]['____________________'] = "สถานะอนุมัติทุนวิจัย";
		$custom_labels["Thai"]['______________________'] = "สถานะกลั่นกรองทุนวิจัย";
		$custom_labels["Thai"]['_____________________________'] = "สถานะกลั่นกรองทุนวิจัยทั้งหมด";
		$custom_labels["Thai"]['TASK_DISBURSE_APPROVE'] = "สถานะเบิกจ่ายทั้งหมด";
		$custom_labels["Thai"]['____________________1'] = "สถานะเห็นชอบคำขอขยาย";
		$custom_labels["Thai"]['____________________2'] = "สถานะอนุมัติคำขอขยาย";
...
$globalSettings["strSMTPUser"] = "chanaphon.l@outlook.com";
$globalSettings["strSMTPServer"] = "smtp-mail.outlook.com";
$globalSettings["strSMTPPort"] = "587";
$globalSettings["strSMTPPassword"] = "Gc594290@";
$globalSettings["strFromEmail"] = "chanaphon.l@outlook.com";
...
$globalSettings["ProjectLogo"]["Thai"] = "กระทรวงการอุดมศึกษา วิทยาศาสตร์ วิจัยและนวัตกรรม";
...
$cLoginTable = "staffUsers";
$cDisplayNameField = "staffFullName";
$cUserNameField	= "staffUsername";
$cPasswordField	= "staffPassword";
$cUserGroupField = "staffUsername";
$cEmailField = "staffEmail";
$cUserpicField = "";
...
$globalSettings["usersDatasourceTable"] = "staffUsers";

$globalSettings["userRequireActivation"] = true;
$globalSettings["userActivationField"] = "staffStatus";

$globalSettings["jwtSecret"] = "K2pY5qpWRvim1LfgC53T";
...
$projectBuildKey = "378_1654607133";
...
$tableCaptions["English"]["ProjectContact"] = "Project Contact";
$tableCaptions["English"]["ProjectStep"] = "Project Step";
$tableCaptions["English"]["ProjectType"] = "Project Type";
$tableCaptions["English"]["project"] = "Project All";
$tableCaptions["English"]["taskTrack"] = "Task Track";
$tableCaptions["English"]["staffUsers"] = "Staff Users";
...
$tableCaptions["English"]["projectStatusApprove"] = "Project Status Approve";
$tableCaptions["English"]["taskDisburse"] = "Task Disburse";
$tableCaptions["English"]["taskTrackApprove"] = "Task Track Approve";
$tableCaptions["English"]["SummaryProject"] = "Summary Report Project";
$tableCaptions["English"]["SummaryProjectDelay"] = "Summary Project Delay";
$tableCaptions["English"]["SummaryTaskTrack"] = "Summary Task Track";
$tableCaptions["English"]["projectAssign"] = "Project Assign";
$tableCaptions["English"]["taskRenew"] = "Task Renew";
$tableCaptions["English"]["taskRenewApprove"] = "Task Renew Approve";
$tableCaptions["English"]["CB_ProjectStep01"] = "CB ProjectStep01";
$tableCaptions["English"]["ProjectCompany"] = "Project Company";
$tableCaptions["English"]["CB_ProjectContact01"] = "CB ProjectContact01";
$tableCaptions["English"]["projectStatusScreen"] = "Project Status Screen";
$tableCaptions["English"]["taskDisburseApprove"] = "Task Disburse Approve";
$tableCaptions["English"]["taskRenewOinion"] = "Task Renew Oinion";
$tableCaptions["Thai"] = array();
$tableCaptions["Thai"][""] = "";
$tableCaptions["Thai"]["ProjectContact"] = "ผู้ติดต่อ";
$tableCaptions["Thai"]["ProjectStep"] = "ขั้นตอน";
$tableCaptions["Thai"]["ProjectType"] = "ประเภททุนวิจัย";
$tableCaptions["Thai"]["project"] = "ระบบยื่นคําขอรับทุนวิจัย (ประเภททุน)  ";
$tableCaptions["Thai"]["taskTrack"] = "ระบบนัดหมายการติดตามงาน";
...
$tableCaptions["Thai"]["projectStatusApprove"] = "ระบบยื่นคําขอรับทุนวิจัย (สถานะอนุมัติโครงการ)";
$tableCaptions["Thai"]["taskDisburse"] = "ระบบการขออนุมัติการเบิกจ่าย";
$tableCaptions["Thai"]["taskTrackApprove"] = "ระบบนัดหมายการติดตามงาน (สถานะงานตามงวด)";
$tableCaptions["Thai"]["SummaryProject"] = "รายงานสรุปโครงการ";
$tableCaptions["Thai"]["SummaryProjectDelay"] = "รายงานสรุปโครงการล่าช้า";
$tableCaptions["Thai"]["SummaryTaskTrack"] = "รายงานสรุปติดตามโครงการ";
$tableCaptions["Thai"]["projectAssign"] = "กำหนดผู้ดูแลโครงการ";
$tableCaptions["Thai"]["taskRenew"] = "ระบบยื่นคําขอขยายระยะเวลาโครงการที่ล่าช้า";
$tableCaptions["Thai"]["taskRenewApprove"] = "ระบบยื่นคําขอขยายระยะเวลาโครงการที่ล่าช้า (สถานะอนุมัติคำขอขยายเวลา)";
$tableCaptions["Thai"]["CB_ProjectStep01"] = "CB ProjectStep01";
$tableCaptions["Thai"]["ProjectCompany"] = "บริษัท/สังกัด";
$tableCaptions["Thai"]["CB_ProjectContact01"] = "CB ProjectContact01";
$tableCaptions["Thai"]["projectStatusScreen"] = "ระบบยื่นคําขอรับทุนวิจัย (สถานะกลั่นกรอง)";
$tableCaptions["Thai"]["taskDisburseApprove"] = "ระบบการขออนุมัติการเบิกจ่าย (สถานะอนุมัติเบิกจ่าย)";
$tableCaptions["Thai"]["taskRenewOinion"] = "ระบบยื่นคําขอขยายระยะเวลาโครงการที่ล่าช้า (สถานะความเห็นชอบคำขอขยายเวลา)";
