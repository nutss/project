...
function checkTableName($shortTName )
{
	...
	if ("projectcontact" == $shortTName )
		return true;
	if ("projectstep" == $shortTName )
		return true;
	if ("projecttype" == $shortTName )
		return true;
	if ("project" == $shortTName )
		return true;
	if ("tasktrack" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("projectstatusapprove" == $shortTName )
		return true;
	if ("taskdisburse" == $shortTName )
		return true;
	if ("tasktrackapprove" == $shortTName )
		return true;
	if ("summaryproject" == $shortTName )
		return true;
	if ("summaryprojectdelay" == $shortTName )
		return true;
	if ("summarytasktrack" == $shortTName )
		return true;
	if ("projectassign" == $shortTName )
		return true;
	if ("taskrenew" == $shortTName )
		return true;
	if ("taskrenewapprove" == $shortTName )
		return true;
	if ("cb_projectstep01" == $shortTName )
		return true;
	if ("projectcompany" == $shortTName )
		return true;
	if ("cb_projectcontact01" == $shortTName )
		return true;
	if ("projectstatusscreen" == $shortTName )
		return true;
	if ("taskdisburseapprove" == $shortTName )
		return true;
	if ("taskrenewoinion" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ProjectContact");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ProjectStep");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ProjectType");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("project");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskTrack");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("projectStatusApprove");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="projectStatusApprove";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskDisburse");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskTrackApprove");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="taskTrackApprove";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SummaryProject");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SummaryProjectDelay");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="SummaryProjectDelay";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SummaryTaskTrack");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="SummaryTaskTrack";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("projectAssign");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskRenew");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskRenewApprove");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="taskRenewApprove";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("CB_ProjectStep01");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="CB_ProjectStep01";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ProjectCompany");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("CB_ProjectContact01");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="CB_ProjectContact01";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("projectStatusScreen");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="projectStatusScreen";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskDisburseApprove");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="taskDisburseApprove";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("taskRenewOinion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
function GetUserPermissionsStatic( $table )
{
	...
	$extraPerm = "";
	if( $table=="ProjectContact" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="ProjectStep" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="ProjectType" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="projectStatusApprove" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="taskDisburse" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="taskTrackApprove" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SummaryProject" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SummaryProjectDelay" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SummaryTaskTrack" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="projectAssign" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="taskRenewApprove" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="CB_ProjectStep01" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="ProjectCompany" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="CB_ProjectContact01" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="projectStatusScreen" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="taskDisburseApprove" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="taskRenewOinion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
