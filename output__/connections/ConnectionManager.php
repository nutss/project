...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connName"] = "project.classicscan.co.th at 192.168.1.111";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;192.168.1.111;project.classicscan.co.th;tr2004;;project.classicscan.co.th;;1"; //currently unused

		$this->_connectionsIdByName["project.classicscan.co.th at 192.168.1.111"] = "mc_at_192_168_1_111";
		...
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "project.classicscan.co.th";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=192.168.1.111;Uid=project.classicscan.co.th;Pwd=tr2004;Database=project.classicscan.co.th;OPTION=3";
		// encription set
