...
require_once("include/projectstatusscreen_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "projectStatusScreen" );
